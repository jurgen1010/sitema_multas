...
public class InfraccionController {
    ...
    public ResponseEntity<Infraccion> actualizar(@PathVariable Long id, @RequestBody Infraccion infraccion,
        ...
        if (!vehiculoService.obtenerVehiculoPorId(idVehiculo).isPresent()) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Vehiculo no encontrada con ID: " + idVehiculo);
        }
